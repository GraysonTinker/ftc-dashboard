...
import com.acmerobotics.dashboard.message.redux.GetHardwareConfig;
...
public enum MessageType {
    ...
    /* hardware config */
    RECEIVE_HARDWARE_CLASSES(null),
    GET_HARDWARE_CONFIG(GetHardwareConfig.class),
    RECEIVE_HARDWARE_CONFIG(ReceiveHardwareConfig.class),
    SAVE_HARDWARE_CONFIG(SaveHardwareConfig.class);
